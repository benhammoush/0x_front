      ...
      <div>
        <div className="relative z-0 w-full text-base-regular">
          <input
            ...
            placeholder=" "
            className={clsx(
              "pt-4 pb-1 rounded-md block w-full px-4 mt-0 bg-transparent dark:bg-darkbg border appearance-none focus:outline-none focus:ring-0 focus:border-gray-400 dark:border-gray-600 border-gray-200",
              {
