...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi dark:text-white">Delivery</h2>
      <div className="my-2">
        <h3 className="text-gray-700 text-small-regular dark:text-white">Address</h3>
      ...
      <div className="my-2">
        <h3 className="text-gray-700 dark:text-white text-small-regular">Delivery method</h3>
        <div>
